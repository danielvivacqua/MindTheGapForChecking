...
namespace MindTheGap.Controllers
{
    public class EventsController : Controller
    {
        ...
        //This is the action that's called when the gaps.cshmtl view is called
        public ActionResult Gaps()
        {
            //This command executes the SQL query against the database
            db.Database.ExecuteSqlCommand("SELECT* INTO GapsTable FROM (SELECT endtime GapStart, LEAD(starttime) OVER(ORDER BY starttime) GapEnd FROM[Event] WHERE starttime < endtime) AS Gaps");
